                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                                ...
                                                <li class="p-2 border-bottom">
                                                    <a href="#!" class="d-flex justify-content-between">
                                                        <div class="d-flex flex-row">
                                                            <div>
                                                                <img src="{{ asset('assets/uploads/users/' . $item->user->image) }}"
                                                            ...
                                                            <div class="pt-1">
                                                                ...
                                                                <p class="small text-muted">{{ $item->sms }}</p>
                                                            </div>
                                                        </div>
                                                        <div class="pt-1">
                            ...
                            <div class="col-md-6 col-lg-7 col-xl-8">
                                ...
                                <div class="pt-3 pe-3 my-custom-scrollbar my-custom-scrollbar-primary"
                                    style="position: relative; height: 400px">
                                ...
                                <div class="text-muted d-flex justify-content-start align-items-center pe-3 pt-3 mt-2">
                                    ...
                                    <form action="" method="post">
                                            <textarea class="form-control form-control-lg message" name="message" id="message" cols="90" rows="2" placeholder="Type message"></textarea>
                                    </form>
