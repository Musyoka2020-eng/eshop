...
<div class="lockscreen-wrapper">
  ...
  <div class="help-block text-center">
    ...
    Thank you for registering with Outlet's get our services here now.
  </div>
  <div class="text-center">
    <a href="{{ route('logout') }}"  onclick="event.preventDefault();
    document.getElementById('logout-form').submit();">Start Shopping </a>
    <form id="logout-form" action="{{ route('logout') }}"   method="POST" class="d-none">
      @csrf
  </form>
  </div>
  <div class="lockscreen-footer text-center">
    Copyright &copy; 2014-2021 <b><a href="#GodIsAble" class="text-black">Steve Codes</a></b><br>
    All rights reserved
  </div>
</div>
<!-- /.center -->
